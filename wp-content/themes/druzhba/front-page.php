...
<head>
	...
	<body>
		...
		<section class="section section__camp-shifts">
			<div class="container">
				<h2 class="section-title">Смены 2020</h2>
				<div class="list-shifts">
					...
					<figure class="shift block-shift">
						<div class="shift-info">
							<div class="info-item info-date no-select">с <?php echo get_field('date')['date-with']; ?> по <?php echo get_field('date')['date-by']; ?> <?php echo get_field('date')['date-year']; ?> г.</div>
