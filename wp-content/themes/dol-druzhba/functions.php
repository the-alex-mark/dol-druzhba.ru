...
define('HOME_ID',          9);
define('ABOUT_ID',        11);
define('HISTORY_ID',      13);
define('INFO_ID',         16);
define('CONDITIONS_ID',   18);
define('NUTRITION_ID',    20);
define('FORPARENTS_ID',   22);
define('FORCOUNSELOR_ID', 24);
define('PRICES_ID',       26);
define('NEWS_ID',         28);
define('GALLERY_ID',      30);
define('CONTACTS_ID',     32);
define('POLICY_ID',       34);
